 ...
 * NetworkViewer.oz
 *
 *    Dynamic graphical display of the network working with attractors and
 *    repellors.
 *
 * LICENSE
 *
 ...
 *
 *    Contributors: Based on the code of Donatien Grolaux and Raphael Collet
 *
 ...
 * NOTES
 *    
 *    This viewer is used to dynamically represent the network topology by
 *    adding nodes/peers and edges to link them. Edges acts as attractors or
 *    repellors in order to form a physical model that dynamically adapt the
 *    graphical representation according to the topology. Nodes and edges can
 *    receive actions from the mouse
 *    
 *-------------------------------------------------------------------------
 */
